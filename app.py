...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Radio(['meta-llama/Llama-2-7b-chat-hf','meta-llama/Llama-2-13b-chat-hf','meta-llama/Llama-2-70b-chat-hf'], info="Turn on the audio recording before changing me. Allow from 2 to 5 minutes for me to load models. I dont recommend changing it, it takes so long to switch models" , value = "meta-llama/Llama-2-7b-chat-hf" , label="TextModel" , interactive=True),
    ],
    outputs="text",
    live=True
)
